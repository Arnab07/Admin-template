<div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a href="#fee" id="fees">
                          <i class="fa fa-laptop"></i>
                          <span>Fee Slip</span></a>
                          </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a href="#teacher" id="teach">
                          <span>Teacher's Record</span></a>
                          </li>
                          <li><a  href="#invoice" id="inv">Invoice</a></li>
                          <li><a  href="#">Coming soon</a></li>
                      </ul>
                  </li>
