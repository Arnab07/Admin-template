...
<div class="row state-overview">
                      ...
                      <section class="panel">
                          <div class="panel-body">
                              <a href="#" class="task-thumb">
                                  <img   src="img/avatar1.jpg" alt="" width="90" height="83">
                              </a>
                                          ...
                                          <div class="timeline-desk">
                                              <div class="panel">
                                                  <div class="panel-body">
                                                      ...
                                                      <div class="album">
                                                          <a href="#">
                                                              <img alt=""   src="img/sm-img-1.jpg" width="48" height="32">
                                                          </a>
                                                          <a href="#">
                                                              <img alt=""   src="img/sm-img-2.jpg" width="48" height="32">
                                                          </a>
                                                          <a href="#">
                                                              <img alt=""   src="img/sm-img-3.jpg" width="48" height="32">
                                                          </a>
                                                          <a href="#">
                                                              <img alt=""   src="img/sm-img-1.jpg" width="48" height="32">
                                                          </a>
                      ...
                      <section class="panel post-wrap pro-box">
                          ...
                          <aside class="post-highlight yellow v-align">
                              <div class="panel-body text-center">
                                  <div class="pro-thumb">
                                      <img   src="img/ring.jpg" alt="" width="112" height="112">
                                  </div>
                              </div>
                          </aside>
                      </section>
                                  ...
                                  <div class="follower">
                                      <div class="panel-body">
                                          ...
                                          <div class="follow-ava">
                                              <img   src="img/follower-avatar.jpg" alt="" width="75" height="75">
                                          </div>
                                      </div>
                                  </div>
    ...
    <script class="include" type="text/javascript"   src="<?php echo base_url()?>assets/js/jquery.dcjqaccordion.2.7.js"  defer></script>
    <script src="<?php echo base_url()?>assets/js/jquery.scrollTo.min.js"  defer></script>
    <script  src="<?php echo base_url()?>assets/js/jquery.nicescroll.js" type="text/javascript"  defer></script>
    <script   src="<?php echo base_url()?>assets/js/jquery.sparkline.js" type="text/javascript"  defer></script>
    <script   src="<?php echo base_url()?>assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js"  defer></script>
    <script src="<?php echo base_url()?>assets/js/owl.carousel.js"  defer></script>
    <script  src="<?php echo base_url()?>assets/js/jquery.customSelect.min.js"  defer></script>
    <script   src="<?php echo base_url()?>assets/js/jquery.scrollTo.min.js" defer></script>
    <script   src="<?php echo base_url()?>assets/js/jquery.nicescroll.js" type="text/javascript"  defer></script>
    <script   src="<?php echo base_url()?>assets/js/respond.min.js"  defer></script>
    ...
    <script   src="<?php echo base_url()?>assets/js/sparkline-chart.js" defer></script>
    <script   src="<?php echo base_url()?>assets/js/easy-pie-chart.js" defer></script>
